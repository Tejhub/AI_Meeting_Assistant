...
"""
                ...
                # Initialize LLM
                llm = ChatOpenAI(model="gpt-3.5-turbo", temperature=0.7, api_key=st.session_state["openai_api_key"])
    ...
    with tab_tasks:
        ...
        if not st.session_state["openai_api_key"]:
            ...
            if st.session_state["todoist_manager"] is None:
                llm = ChatOpenAI(model="gpt-3.5-turbo", temperature=0.3, api_key=st.session_state["openai_api_key"])
